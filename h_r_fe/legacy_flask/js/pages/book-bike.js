...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  `;
    ...
    const daysCountEl = document.getElementById("bikeDaysCount");
    const rentalTotalEl = document.getElementById("bikeRentalTotal");
    const grandTotalEl = document.getElementById("bikeGrandTotal");
    const minusBtn = document.getElementById("daysMinus");
    const plusBtn = document.getElementById("daysPlus");
