document.addEventListener("DOMContentLoaded", async () => {
  ...
  const nightsEl = document.getElementById("nightsCount") as HTMLElement;
  const totalEl = document.getElementById("totalPrice") as HTMLElement;
  ...
  const guestsSelect = document.getElementById("guestsCount") as HTMLSelectElement;
